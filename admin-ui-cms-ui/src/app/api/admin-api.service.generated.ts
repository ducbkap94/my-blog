...
export class AdminApiPostApiClient {
     ...
     * @param categotyId (optional) 
     * @param pageIndex (optional) 
     * @param pageSize (optional) 
     * @return Success
     */
    getPostsPaging(keywork?: string | undefined, categotyId?: string | undefined, pageIndex?: number | undefined, pageSize?: number | undefined): Observable<PostInListDtoPagedResult> {
        ...
        if (categotyId === null)
            throw new Error("The parameter 'categotyId' cannot be null.");
        else if (categotyId !== undefined)
            url_ += "categotyId=" + encodeURIComponent("" + categotyId) + "&";
        if (pageIndex === null)
